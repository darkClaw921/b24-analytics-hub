...
- **chats.py** - CRUD операции с чатами
...
**ChatList/**
- **ChatList.tsx** - список чатов пользователя, создание новых чатов
...
#### Стили (`styles/`)
- **bitrix24.css** - стили в духе Bitrix24 (цвета, компоненты, адаптивность)
...
- Компоненты в стиле Bitrix24 UI
